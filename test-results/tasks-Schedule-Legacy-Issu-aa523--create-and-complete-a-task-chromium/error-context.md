...
- Name: tasks.spec.ts >> Schedule & Legacy Issues >> should create and complete a task
...
Locator: getByText('测试任务-1784022505157')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('测试任务-1784022505157')
